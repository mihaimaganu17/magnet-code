...
- **File Content:** - When creating or editing files, do not echo the file contents in the chat. Only confirm the action (file path + brief summary). Show code only if the user explicitly asks to see it.
